            ...
            <div class="flex items-center">
                ...
                <div class="flex items-center space-x-4 ml-auto">
                    <div class="flex items-center">
                        ...
                        <svg v-else
                         class="w-4 h-4 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"></path></svg>
                        <div class="font-bold">
